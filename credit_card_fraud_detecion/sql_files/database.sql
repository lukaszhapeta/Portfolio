...
# Creating a table for card types
...
# Trigger automatically generating card number, expiration date, CVV, and card type during record insertion
DELIMITER //
...
BEGIN
    ...
    -- Generating card_type - a value of 1 or 2
    SET NEW.card_type = FLOOR(RAND() * 2) + 1;
END //
DELIMITER ;
